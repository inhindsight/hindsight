defmodule AcceptTest do
    ...
    describe "new/1" do
        ...
        test "does not overwrite an id if one is present", %{input_with_id: input_with_id, accept_with_id: accept_with_id} do
