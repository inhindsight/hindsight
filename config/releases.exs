  ...
  brook: [
    ...
    storage: [
      ...
      init_arg: [
        table: "define_state",
        postgrex_args: [
          hostname: System.get_env("DEFINE_DB_HOST", "localhost"),
          username: System.get_env("DEFINE_DB_USER", "define_app_user"),
          password: System.get_env("DEFINE_DB_PASSWORD", "define123"),
          database: System.get_env("DEFINE_DB_NAME", "define_app_state")
        ]
      ]
    ],
    dispatcher: Brook.Dispatcher.Noop
